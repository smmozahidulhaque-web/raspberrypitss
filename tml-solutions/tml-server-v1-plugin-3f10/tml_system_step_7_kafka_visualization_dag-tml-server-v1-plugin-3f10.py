...
default_args = {
  ...
  'dashboardhtml': 'iot-failure-machinelearning-plugin.html', # <<< *** name of your dashboard file: This one is ONLY for preprocessing
  'dashboardhtml-ml': 'iot-failure-machinelearning-plugin.html', # <<< *** This one is IF you include ML dag
